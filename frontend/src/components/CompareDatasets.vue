...
<style scoped>
.cd-check { color: var(--ink-soft); }.cd-check input { accent-color: var(--accent); }.cd-btn { background: var(--ink); }.cd-btn:hover { background: var(--accent-hover); }.cd-card { background: var(--panel-soft); border-color: var(--line); }.cd-ds-name { color: var(--ink); border-color: var(--line); }.cd-stat-val { color: var(--ink); }.cd-stat-lbl, .cd-loading { color: var(--text-faint); }.cd-pos { color: var(--positive); }
</style>
